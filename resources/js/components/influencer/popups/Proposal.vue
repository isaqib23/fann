<template>
    <v-flex>
                ...
                <v-row class="mx-auto" justify="start">
                    <v-badge color="transparent">
                        ...
                        <v-row justify="start">
                            ...
                            <v-col class="text-center inner_wrapper mt-8" cols="12" md="10">
                                ...
                                <v-container class="pa-0">
                                    ...
                                    <div class="text-start ml-4 mt-2">
                                        <v-row justify="start">
                                            ...
                                            <v-col cols="12" md="3" style="position: relative !important;">
                                                <v-btn class="text-capitalize" color="success" depressed height="40" style="position: absolute !important; bottom: 24px">Send Proposal</v-btn>
                                            </v-col>
                                        </v-row>
                                    </div>
                                </v-container>
        ...
        <v-card class="mx-auto card_wrapper pa-12" color="gutterDark">
            <v-card-title>
                <div class="subtitle-1 mb-2"><strong>Touch Points Overview</strong></div>
            </v-card-title>
            <v-card-text>
                <v-simple-table>
                    <tbody>
                    <tr v-for="i in 8" :key="i" class="my-3">
                        ...
                        <td class="text-center">
                            Original Price: <span class="primary--text">$18</span>
                        </td>
                        <td class="text-center">
                            Make Your Request:
                            <v-text-field
                                ...
                                outlined
                                style="width: 25%"
                                class="d-inline-block ml-2 custom_dropdown"
                            ></v-text-field>
                        </td>
                    </tr>
                    </tbody>
