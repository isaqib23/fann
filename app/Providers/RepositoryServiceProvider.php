...
use App\Repositories\CampaignTouchPointProductShippmentRepositoryEloquent;
...
class RepositoryServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        $this->app->bind(CampaignTouchPointProductShippmentRepository::class, CampaignTouchPointProductShippmentRepositoryEloquent::class);
